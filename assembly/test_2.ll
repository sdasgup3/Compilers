...
entry:
  ...
  store i32 0, i32* %five_times_x, align 4
  %0 = load i32, i32* %x, align 4
  %1 = load i32, i32* %five_times_x, align 4
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i32 0, i32 0), i32 %0, i32 %1)
  %2 = load i32, i32* %x, align 4
  %3 = call i32 asm "leal ($1,$1,4), $0", "=r,r,~{dirflag},~{fpsr},~{flags}"(i32 %2) #2, !srcloc !1
  store i32 %3, i32* %five_times_x, align 4
  %4 = load i32, i32* %x, align 4
  %5 = load i32, i32* %five_times_x, align 4
