...
foreach(file IN LISTS files)
  ...
  list(APPEND update_format_depends "llvm-update-format${i}")

  math(EXPR i ${i}+1)
endforeach()

add_custom_target(check-format DEPENDS ${check_format_depends})
set_target_properties(check-format PROPERTIES FOLDER "LLVM_PROJS")

add_custom_target(update-format DEPENDS ${update_format_depends})
set_target_properties(update-format PROPERTIES FOLDER "LLVM_PROJS")
